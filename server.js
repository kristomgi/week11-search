...
app.post('/search', (req, res) => {
    ...
    let movieUrl = `https://api.themoviedb.org/3/search/movie?api_key=6703c4f12aea492025c79966161a52c0&query=${movieTitle}`;
    let genres = 'https://api.themoviedb.org/3/genre/movie/list?api_key=6703c4f12aea492025c79966161a52c0&language=en-US';
